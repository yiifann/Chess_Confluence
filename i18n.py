...
TRANSLATIONS: dict[Language, dict[str, str]] = {
    "zh": {
        ...
        "menu.escape": "ESC 退出",
        "options.title": "单人对局选项",
        "options.side": "选择执棋方",
        "options.difficulty": "AI 难度",
        "options.difficulty.easy": "简单",
        "options.difficulty.medium": "中等",
        "options.difficulty.hard": "困难",
        "options.difficulty_help.easy": "AI 随机选择合法走法，适合初次体验。",
        "options.difficulty_help.medium": "AI 会优先吃子、活动棋子并向对方主将推进。",
        "options.difficulty_help.hard": "AI 还会预判对手下一步的吃子和主将威胁。",
        "options.setup": "AI 阵容生成方式",
        "options.setup.deterministic": "固定（可复现）",
        "options.setup.varied": "随机变化",
        "options.preview": "赛后允许查看初始阵容",
        "options.yes": "是",
        "options.no": "否",
        "options.start": "开始秘密部署",
        "options.back": "返回",
        "side.red": "红方",
        "side.black": "黑方",
        "game.xiangqi": "中国象棋",
        ...
        "status.ai_moved": "AI 将{piece}移动到 ({column}, {row})。轮到{side}。",
        "status.undo": "已撤销上一回合。",
        "status.match_saved": "对局记录已保存到 {path}",
        "status.save_failed": "无法保存对局记录。",
        "status.load_failed": "无法载入上次保存的对局。",
        ...
        "play.status": "状态",
        "play.ai_opponent": "对手：{side} · {difficulty} AI",
        "play.undo": "撤销",
        "play.save": "保存",
        ...
        "game_over.same_armies": "相同阵容再战",
        "game_over.new_ai": "更换 AI 阵容",
        "game_over.replay": "逐步回放",
        "game_over.setup_preview": "查看初始阵容",
        "game_over.save": "保存对局记录",
        "game_over.menu": "返回菜单",
        "replay.title": "对局回放",
        "replay.setup_title": "双方初始阵容",
        "replay.setup_body": "比赛开始时的完整部署",
        "replay.progress": "第 {current} / {total} 步",
        "replay.move": "{side}移动到 ({column}, {row})",
        "replay.resigned": "{side}认输",
        "replay.previous": "上一步",
        "replay.next": "下一步",
        "replay.done": "完成",
    },
    "en": {
        ...
        "menu.load": "Load last match",
        "menu.tagline": (
            "Build secret mixed armies and capture the opposing king to win"
        ),
        "menu.escape": "ESC to quit",
        "options.title": "Single-player options",
        "options.side": "Choose your side",
        "options.difficulty": "AI difficulty",
        "options.difficulty.easy": "Easy",
        "options.difficulty.medium": "Medium",
        "options.difficulty.hard": "Hard",
        "options.difficulty_help.easy": (
            "The AI chooses random legal moves—ideal for a first game."
        ),
        "options.difficulty_help.medium": (
            "The AI values captures, mobility, and progress toward your leader."
        ),
        "options.difficulty_help.hard": (
            "The AI also evaluates your next capture and leader threats."
        ),
        "options.setup": "AI army generation",
        "options.setup.deterministic": "Fixed (reproducible)",
        "options.setup.varied": "Varied",
        "options.preview": "Allow initial setup preview after match",
        "options.yes": "Yes",
        "options.no": "No",
        "options.start": "Start secret setup",
        "options.back": "Back",
        "side.red": "Red",
        "side.black": "Black",
        ...
        "status.ai_moved": ("AI moved {piece} to ({column}, {row}). {side} to move."),
        "status.undo": "Undid the previous turn.",
        "status.match_saved": "Match record saved to {path}",
        "status.save_failed": "The match record could not be saved.",
        "status.load_failed": "The last saved match could not be loaded.",
        ...
        "play.status": "Status",
        "play.ai_opponent": "Opponent: {side} · {difficulty} AI",
        "play.undo": "Undo",
        "play.save": "Save",
        ...
        "game_over.same_armies": "Same armies",
        "game_over.new_ai": "New AI army",
        "game_over.replay": "Replay moves",
        "game_over.setup_preview": "Initial setups",
        "game_over.save": "Save match record",
        "game_over.menu": "Main menu",
        "replay.title": "Match replay",
        "replay.setup_title": "Initial armies",
        "replay.setup_body": "The complete deployment at the start of the match",
        "replay.progress": "Action {current} / {total}",
        "replay.move": "{side} moved to ({column}, {row})",
        "replay.resigned": "{side} resigned",
    ...
    "fr": {
        ...
        "menu.load": "Charger la dernière partie",
        "menu.tagline": "Composez vos armées secrètes et capturez le roi adverse",
        "menu.escape": "Échap pour quitter",
        "options.title": "Options de la partie solo",
        "options.side": "Choisissez votre camp",
        "options.difficulty": "Difficulté de l’IA",
        "options.difficulty.easy": "Facile",
        "options.difficulty.medium": "Moyenne",
        "options.difficulty.hard": "Difficile",
        "options.difficulty_help.easy": (
            "L’IA choisit un coup légal au hasard, idéal pour débuter."
        ),
        "options.difficulty_help.medium": (
            "L’IA privilégie les prises, la mobilité et l’approche du roi."
        ),
        "options.difficulty_help.hard": (
            "L’IA évalue aussi vos prochaines prises et menaces contre son roi."
        ),
        "options.setup": "Génération de l’armée de l’IA",
        "options.setup.deterministic": "Fixe (reproductible)",
        "options.setup.varied": "Variable",
        "options.preview": "Autoriser l’aperçu des armées après la partie",
        "options.yes": "Oui",
        "options.no": "Non",
        "options.start": "Commencer le déploiement",
        "options.back": "Retour",
        "side.red": "Rouges",
        "side.black": "Noirs",
        "game.xiangqi": "Xiangqi",
        ...
        "status.ai_moved": ("L’IA déplace {piece} en ({column}, {row}). Aux {side}."),
        "status.undo": "Le tour précédent a été annulé.",
        "status.match_saved": "Partie enregistrée dans {path}",
        "status.save_failed": "Impossible d’enregistrer la partie.",
        "status.load_failed": "Impossible de charger la dernière partie.",
        ...
        "play.status": "État",
        "play.ai_opponent": "Adversaire : {side} · IA {difficulty}",
        "play.undo": "Annuler",
        "play.save": "Enregistrer",
        ...
        "game_over.same_armies": "Mêmes armées",
        "game_over.new_ai": "Nouvelle armée IA",
        "game_over.replay": "Revoir les coups",
        "game_over.setup_preview": "Armées initiales",
        "game_over.save": "Enregistrer la partie",
        "game_over.menu": "Menu principal",
        "replay.title": "Relecture de la partie",
        "replay.setup_title": "Armées initiales",
        "replay.setup_body": "Le déploiement complet au début de la partie",
        "replay.progress": "Action {current} / {total}",
        "replay.move": "{side} se déplace en ({column}, {row})",
        "replay.resigned": "{side} abandonne",
        "replay.previous": "Précédent",
        "replay.next": "Suivant",
        "replay.done": "Terminer",
    },
}
